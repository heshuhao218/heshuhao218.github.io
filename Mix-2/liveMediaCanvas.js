...
function animate() {
    ...
    myAvatarObj.rotation.x += dir;
    myAvatarObj.rotation.y += dir;
    myAvatarObj.rotation.z += dir;
  
    if (myAvatarObj.scale.x > 2 || myAvatarObj.scale.x < -2) {
        myAvatarObj = -dir;
    }
}
